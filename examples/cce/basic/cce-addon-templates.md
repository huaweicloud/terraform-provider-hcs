...
[`hcs_cce_addon_template`](https://registry.terraform.io/providers/huaweicloud/huaweicloud/latest/docs/data-sources/cce_addon_template)
.
...
resource "hcs_cce_addon" "autoscaler" {
  ...
  values {
    basic  = jsondecode(data.hcs_cce_addon_template.autoscaler.spec).basic
    custom = merge(
      jsondecode(data.hcs_cce_addon_template.autoscaler.spec).parameters.custom,
      {
        cluster_id = var.cluster_id
