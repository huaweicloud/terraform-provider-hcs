...
func deleteURL(c *golangsdk.ServiceClient, topicUrn string, subscriptionUrn string) string {
	return c.ServiceURL("topics", topicUrn, "subscriptions", subscriptionUrn)
}
