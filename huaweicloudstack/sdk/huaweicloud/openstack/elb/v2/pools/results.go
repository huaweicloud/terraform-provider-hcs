...
import (
	...
	"github.com/huaweicloud/terraform-provider-hcs/huaweicloudstack/sdk/huaweicloud/openstack/elb/v2/monitors"
...
type Pool struct {
	...
	// Specifies the ID of the project to which the backend server belongs.
	// This parameter has the same meaning as tenant_id.
	ProjectID string `josn:"project_id"`
