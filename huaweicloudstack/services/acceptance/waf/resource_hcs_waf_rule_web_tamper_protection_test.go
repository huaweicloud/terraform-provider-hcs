...
func TestAccWafRuleWebTamperProtection_basic(t *testing.T) {
	...
	rName := "hcs_waf_rule_web_tamper_protection.rule_1"
...
func TestAccWafRuleWebTamperProtection_withEpsID(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccWafRuleWebTamperProtection_basic_withEpsID(name, acceptance.HCS_ENTERPRISE_PROJECT_ID_TEST),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
