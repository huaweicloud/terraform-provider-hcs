...
func TestAccWafRuleBlackList_basic(t *testing.T) {
	...
	rName1 := "hcs_waf_rule_blacklist.rule_1"
	rName2 := "hcs_waf_rule_blacklist.rule_2"
	rName3 := "hcs_waf_rule_blacklist.rule_3"
...
func TestAccWafRuleBlackList_withEpsID(t *testing.T) {
	...
	randName := acceptance.RandomAccResourceName()
	rName := "hcs_waf_rule_blacklist.rule"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccWafRuleBlackList_basic_withEpsID(randName, acceptance.HCS_ENTERPRISE_PROJECT_ID_TEST),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
			...
			{
				Config: testAccWafRuleBlackList_update_withEpsID(randName, acceptance.HCS_ENTERPRISE_PROJECT_ID_TEST),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
...
resource "hcs_waf_rule_blacklist" "rule_3" {
  policy_id        = hcs_waf_policy.policy_1.id
  address_group_id = hcs_waf_address_group.test.id
  action           = 2
  name             = "%s_update"
  description      = ""
}
