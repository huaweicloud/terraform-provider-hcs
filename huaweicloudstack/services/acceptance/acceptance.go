...
var (
	HW_SKIP_UNSUPPORTED_TEST = os.Getenv("HW_SKIP_UNSUPPORTED_TEST")
	...
	HW_EIP_ID2               = os.Getenv("HW_EIP_ID2")
	HW_EIP_ADDRESS           = os.Getenv("HW_EIP_ADDRESS")
	HW_EIP_ADDRESS2          = os.Getenv("HW_EIP_ADDRESS2")
	HW_NETWORK_ID            = os.Getenv("HW_NETWORK_ID")
	HW_SUBNET_ID             = os.Getenv("HW_SUBNET_ID")
	HW_SG_ID                 = os.Getenv("HW_SG_ID")
	HW_SG_ID2                = os.Getenv("HW_SG_ID2")
...
func TestAccPreCheckEipId(t *testing.T) {
	if HW_EIP_ID == "" {
		t.Skip("HW_EIP_ID must be set for acceptance tests.")
	}
}
...
func TestAccPreCheckKmsKey(t *testing.T) {
	if HW_KMS_KEY_ID == "" {
		t.Skip("HW_KMS_KEY_ID must be set for encryption acceptance tests")
	}
}
