...
func TestAccDwsAlarmSubs_basic(t *testing.T) {
	...
	rName := "hcs_dws_alarm_subscription.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName, "notification_target", "hcs_smn_topic.test", "id"),
					resource.TestCheckResourceAttrPair(rName, "notification_target_name", "hcs_smn_topic.test", "name"),
...
resource "hcs_dws_alarm_subscription" "test" {
  name                     = "%s"
  enable                   = "1"
  notification_target      = hcs_smn_topic.test.id
  notification_target_type = "SMN"
  notification_target_name = hcs_smn_topic.test.name
  time_zone                = "GMT+09:00"
