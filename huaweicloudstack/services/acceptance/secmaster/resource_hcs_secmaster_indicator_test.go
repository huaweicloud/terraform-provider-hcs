...
func getIndicatorResourceFunc(cfg *config.HcsConfig, state *terraform.ResourceState) (interface{}, error) {
...
func TestAccIndicator_basic(t *testing.T) {
	...
	rName := "hcs_secmaster_indicator.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		PreCheck: func() {
			...
			acceptance.TestAccPreCheckSecMasterIndicator(t)
		},
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testIndicator_basic_update2(nameUpdate),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(rName, "workspace_id", acceptance.HCS_SECMASTER_WORKSPACE_ID),
					resource.TestCheckResourceAttr(rName, "name", nameUpdate),
					resource.TestCheckResourceAttr(rName, "threat_degree", "White"),
					resource.TestCheckResourceAttr(rName, "status", "Revoked"),
					resource.TestCheckResourceAttr(rName, "confidence", "90"),
					resource.TestCheckResourceAttr(rName, "first_occurrence_time", "2023-10-26T09:33:55.000+08:00"),
					resource.TestCheckResourceAttr(rName, "last_occurrence_time", "2023-10-27T21:15:30.000+08:00"),
					resource.TestCheckResourceAttr(rName, "granularity", "1"),
...
`, acceptance.HCS_SECMASTER_WORKSPACE_ID, name, acceptance.HCS_SECMASTER_INDICATOR_TYPE_ID)
}
...
`, acceptance.HCS_SECMASTER_WORKSPACE_ID, name, acceptance.HCS_SECMASTER_INDICATOR_TYPE_ID_UPDATE)
}

func testIndicator_basic_update2(name string) string {
	return fmt.Sprintf(`
resource "hcs_secmaster_indicator" "test" {
  workspace_id = "%[1]s"
  name         = "%[2]s"
