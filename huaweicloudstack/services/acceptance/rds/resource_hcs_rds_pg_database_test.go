...
func getPgDatabaseResourceFunc(cfg *config.HcsConfig, state *terraform.ResourceState) (interface{}, error) {
...
func TestAccPgDatabase_basic(t *testing.T) {
	...
	rName := "hcs_rds_pg_database.test"
