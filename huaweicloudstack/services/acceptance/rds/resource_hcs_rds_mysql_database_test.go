...
func getMysqlDatabaseResourceFunc(cfg *config.HcsConfig, state *terraform.ResourceState) (interface{}, error) {
...
func TestAccMysqlDatabase_basic(t *testing.T) {
	...
	rName := "hcs_rds_mysql_database.test"
...
`, testAccRdsMysqlInstance_basic(name, dbPwd), name, description)
}
