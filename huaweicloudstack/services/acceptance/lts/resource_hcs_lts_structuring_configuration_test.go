...
func getStructConfigResourceFunc(cfg *config.HcsConfig, state *terraform.ResourceState) (interface{}, error) {
	var (
...
func TestAccStructConfig_basic(t *testing.T) {
	...
	rName := "hcs_lts_structuring_configuration.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(rName, "template_id", acceptance.HCS_LTS_STRUCT_CONFIG_TEMPLATE_ID),
					resource.TestCheckResourceAttr(rName, "template_name", acceptance.HCS_LTS_STRUCT_CONFIG_TEMPLATE_NAME),
					resource.TestCheckResourceAttr(rName, "quick_analysis", "true"),
					resource.TestCheckResourceAttrSet(rName, "demo_log"),
				),
			},
...
`, testAccLtsStream_basic(name), acceptance.HCS_LTS_STRUCT_CONFIG_TEMPLATE_ID, acceptance.HCS_LTS_STRUCT_CONFIG_TEMPLATE_NAME)
}
