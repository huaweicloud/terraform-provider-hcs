...
func TestAccDataSourceELbCertificateV3_basic(t *testing.T) {
	...
	dataSourceName := "data.hcs_elb_certificate.cert_1"
...
func testAccELbCertDataSourceV3_conf(name string) string {
	return fmt.Sprintf(`
data "hcs_elb_certificate" "cert_1" {
  name = hcs_elb_certificate.certificate_1.name

  depends_on = [
    hcs_elb_certificate.certificate_1
  ]
}
