...
description: |-
  Manages a GaussDB OpenGauss parameter template resource within HuaweiCloudStack.
---
...
* `instance_mode` - (Optional, String, ForceNew) Specifies the deployment model. The valid values are as follows:
  + **ha**. Primary and Standby Edition.
  + **combined**. Distributed Edition Financial Version (Standard Type).
  + **combined_hcs2**. Distributed Edition Enterprise Version.
  + **combined_hcs3**. Distributed Edition Financial Version (Standard Type).
  + **combined_hcs4**. Distributed Edition Financial Version (Data Computing Type, Disaster Recovery Primary).
  + **combined_hcs5**. Distributed Edition Financial Version (Data Computing Type, Disaster Recovery Standby).
  + **combined_hcs6**. Distributed Edition Enterprise Version, Disaster Recovery Instance. This value is only supported
    in **HCS 8.5.1** and **later** version.
  + **combined_hcs7**. Distributed Edition Enterprise Version (Enhanced). This value is only supported in **HCS 8.5.1**
    and **later** version.
