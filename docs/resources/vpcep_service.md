...
* `server_type` - (Required, String, ForceNew) Specifies the backend resource type. The value can be **VM** or **LB**. Changing this creates a new VPC endpoint service.
...
```
$ terraform import hcs_vpcep_service.test_service 950cd3ba-9d0e-4451-97c1-3e97dd515d46
```
