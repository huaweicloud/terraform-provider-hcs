...
page_title: "HuaweiCloudStack: hcs_swr_repository"
description: ""
---

# hcs_swr_repository

Manages a SWR repository resource within HuaweiCloudStack.
...
```
$ terraform import hcs_swr_repository.test org-name/repo-name
```
