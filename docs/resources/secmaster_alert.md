...
page_title: "HuaweiCloudStack: hcs_secmaster_alert"
description: |-
  Manages a SecMaster alert resource within HuaweiCloudStack.
---
...
resource "hcs_secmaster_alert" "test" {
  ...
  first_occurrence_time = "2025-03-05T09:33:55.000+08:00"
...
```bash
$ terraform import hcs_secmaster_alert.test <workspace_id>/<id>
```
