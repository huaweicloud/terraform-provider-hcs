...
page_title: "HuaweiCloudStack: hcs_swr_repository_sharing"
description: ""
---

# hcs_swr_repository_sharing

Manages a SWR repository sharing resource within HuaweiCloudStack.
...
```
$ terraform import hcs_swr_repository_sharing.test org-name/repo-name/sharing-account
```
