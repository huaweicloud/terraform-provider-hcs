...
page_title: "HuaweiCloudStack: hcs_swr_organization"
description: ""
---

# hcs_swr_organization

Manages a SWR organization resource within HuaweiCloudStack.
...
```
$ terraform import hcs_swr_organization.test org-name
```
