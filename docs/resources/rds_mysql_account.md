...
page_title: "HuaweiCloudStack: hcs_rds_mysql_account"
description: |-
  Manages RDS Mysql account resource within HuaweiCloudStack.
---
...
```bash
$ terraform import hcs_rds_mysql_account.account_1 <instance_id>/<name>
```
...
```hcl
resource "hcs_rds_mysql_account" "account_1" {
    ...
