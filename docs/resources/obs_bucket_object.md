...
description: |-
  Manages an OBS bucket object resource within HuaweiCloudStack. 
---
...
* `content_type` - (Optional, String) The standard MIME type describing the format of the object data, e.g.
...
->**Note** Either `source` or `content` must be provided to specify the bucket content. These two arguments
