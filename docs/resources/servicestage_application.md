...
page_title: "HuaweiCloudStack: hcs_servicestage_application"
description: |-
  Manages a ServiceStage application resource within HuaweiCloudStack 
---
...
* `environment` - (Optional, List) Specifies the configurations of the environment variables.
  The [environment](#servicestage_app_environments) object structure is documented below.
...
* `variable` - (Required, List) Specifies the list of environment variables.
  The [variable](#servicestage_app_variables) object structure is documented below.
...
```bash
$ terraform import hcs_servicestage_application.test eeea08e7-c838-4794-926c-abc12f3e10e8
```
