...
* `flavor_id` - (Optional, String) Specifies the Kafka [flavor ID](https://support.huawei.com/enterprise/zh/doc/EDOC1100369421?section=k001),
...
```
 $ terraform import hcs_dms_kafka_instance.instance_1 8d3c7938-dc47-4937-a30f-c80de381c5e3
```
...
```hcl
resource "hcs_dms_kafka_instance" "instance_1" {
    ...
