...
Manages a WAF Data Masking Rule resource within HuaweiCloudStack.
...
```bash
$ terraform import hcs_waf_rule_data_masking.test <policy_id>/<rule_id>
```

* Using `policy_id`, `rule_id` and `enterprise_project_id`, separated by slashes, e.g.

```bash
$ terraform import hcs_waf_rule_data_masking.test <policy_id>/<rule_id>/<enterprise_project_id>
```
