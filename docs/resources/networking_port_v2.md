...
Manages a Port resource within HuaweiCloudStack.
...
resource "hcs_networking_port" "myport" {
  name           = "port"
...
```
$ terraform import hcs_networking_port.port_1 eae26a3e-1c33-4cc1-9c31-0cd729c438a1
```
