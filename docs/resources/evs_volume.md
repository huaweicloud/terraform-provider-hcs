...
* `encryption_info` - (Optional, List) Specifies the encryption configuration for the volume.
  - `cmk_id` - (Optional, String) The KMS key ID.
  - `cipher` - (Optional, String) Encryption algorithm, supports: `AES256-XTS`, `SM4-XTS`.
