...
Manages a WAF rule information leakage prevention resource within HuaweiCloudStack.
...
resource "hcs_waf_rule_information_leakage_prevention" "test" {
...
```bash
$ terraform import hcs_waf_rule_information_leakage_prevention.test <policy_id>/<rule_id>
```

* Using `policy_id`, `rule_id` and `enterprise_project_id`, separated by slashes, e.g.

```bash
$ terraform import hcs_waf_rule_information_leakage_prevention.test <policy_id>/<rule_id>/<enterprise_project_id>
```
