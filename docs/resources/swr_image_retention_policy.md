...
page_title: "HuaweiCloudStack: hcs_swr_image_retention_policy"
description: ""
---

# hcs_swr_image_retention_policy

Manages a SWR image retention policy within HuaweiCloudStack.
...
```bash
$ terraform import hcs_swr_image_retention_policy.test <organization_name>/<repository_name>/<retention_id>
```
