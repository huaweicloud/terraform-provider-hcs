...
Manages a WAF precise protection rule resource within HuaweiCloudStack.
...
```bash
$ terraform import hcs_waf_rule_precise_protection.test <policy_id>/<rule_id>
```

* Using `policy_id`, `rule_id` and `enterprise_project_id`, separated by slashes, e.g.

```bash
$ terraform import hcs_waf_rule_precise_protection.test <policy_id>/<rule_id>/<enterprise_project_id>
```
