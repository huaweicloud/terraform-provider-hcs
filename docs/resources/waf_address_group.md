...
Manages a WAF address group resource within HuaweiCloudStack.
...
resource "hcs_waf_address_group" "example_group" {
...
```bash
$ terraform import hcs_waf_address_group.test <id>
```

* Using `id` and `enterprise_project_id`, separated by a slash, e.g.

```bash
$ terraform import hcs_waf_address_group.test <id>/<enterprise_project_id>
```
